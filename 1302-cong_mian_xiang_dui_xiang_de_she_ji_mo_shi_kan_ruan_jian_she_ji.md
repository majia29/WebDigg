...
我有种强烈的感觉—— **Unix对这些所谓的OO的设计模式实现得更好** 。因为Unix就一条设计模式！再次推荐《 _[The Art of Unix Programming](http://book.douban.com/subject/5387401/)_ 》

![image](images/1302-cmxdxdsjmskrjsj-0.png)

#### 餐后甜点

我上面提到了《 _[The Art of Unix Programming](http://book.douban.com/subject/5387401/)_ 》，所以我有必要再谈谈这本书中我中毒最深的一章《模块性：保持清晰和简洁》中所谈到的胶合层。
